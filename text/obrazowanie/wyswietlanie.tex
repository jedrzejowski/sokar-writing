...
Rekonstrukcja wielopłaszczyznowa, zwykle dane dotyczące objętości medycznej są gromadzone wzdłuż jednej osi ciała (np. poprzecznej).
...
MTF \fromEng{Modulation Transfer Function} służąca do odwzorowania wartości szarości obrazów wokseli na wartości krycia typów tkanek (np. kości).
