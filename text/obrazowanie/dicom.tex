...
Element danych, zwany przez standard \DICOM \keyword{Data Element} jest rekordem, który przechowuje pojedynczą informacje o obiekcie.
...
\begin{itemize}
    ...
    \item \keyword{Value Representation}, w skrócie \keyword{VR} – to dwa bajty w postaci tekstu, informujące o formacie w jakim parametr został zapisany.
...
\par
\keyword{Tag} to unikalny znacznik pozwalający określać czego dotyczą dane zapisane w elemencie danych.
...
\keyword{VR} to reprezentacja wartości, który informuje w jakim formacie jest zapisany parametr obrazu.
...
\begin{itemize}
    \item AS --- Age String --- wiek lub długość życia
          ...
          Długość danych to zawsze wynosi 4 bajty.
