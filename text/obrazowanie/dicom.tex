...
\begin{itemize}
    ...
    Konwerter w mojej aplikacji zmienia tą wartość na tekst w postaci czytelnej, np: \dataword{18 weeks} lub \dataword{3 years}, oraz jest wrażliwy na obecny język aplikacji.
