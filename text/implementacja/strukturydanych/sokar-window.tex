...
\par
W lewej części okna znajduje się element listy implementowany przez \sokarclass{FileTree},
Zawiera on w sobie model drzewa plików systemu, który z kolei jest implementowany przez klasę \qtclass{QFileSystemModel}.
    ...
    \item File:
          \begin{itemize}
              ...
              \item Export as --- zapisanie obrazu w formacie JPEG, BMP, GIF lub PNG
                    Zapisywanie jest zaimplementowane przez funkcję \qtfunction{QImage}{save}, która umożliwia zapisanie obrazu do pliku.
