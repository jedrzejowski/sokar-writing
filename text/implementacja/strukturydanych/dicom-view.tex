...
Trzeci (14) przycisk wymusza tryb jednego okienkowania dla wszystkich klatek filmu.%TOASK
...
Uruchamiany jest timer, czyli obiekt klasy \qtclass{QTimer}, na czas równy czasu trwania sceny zapisanego w kroku przemnożonego przez liczbę z prządki.
