...
struct Pixel {
    ...
    quint8 blue = 0;   
          ...
          \stdclass{vector}{container/vector} zapewnia ciągłość obiektów w pamięci, dlatego można potraktować ten obiekt jako tablice stukrur \sokarclass{Pixel}.
    ...
    \item \cppcode{qImage} obiekt obrazu klasy \qtclass{QImage}.
          ...
          Proszę zwrócić uwagę, że tablica ze strukturą \sokarclass{Pixel} odpowiada temu formatowi.
    ...
    \item \cppcode{iconPixmap} obiekt obrazu ikonu, klasy \qtclass{QPixmap}, docelowo powinien mieć 128 pikseli na 128 pikseli.
          Interpolacja z obrazu medycznego jest zapewniana przez funkcje \qtfunction{QPixmap}{scaledToWidth}
