\label{sec:sokar-dicomscene-monochrome}
...
\par
W wersji z LUT, na podczas tworzenia okienka jest alokowany wektor obiektów \sokarclass{Pixel} klasy \stdclass{vector}.
