...
Odbiór wszystkich sygnałów jest implementowany przez wirtualną funkcje \sokarfunction{DicomScene}{toolBarActionSlot}, która jest slotem.
...
Dodatkowo funkcja ta dostarcza obiekt klasy \qtclass{QGraphicsSceneMouseEvent}, w którym znajdują się informacje zarówno o obecnej pozycji myszki jak i poprzedniej pozycji myszki.
