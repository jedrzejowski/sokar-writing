...
\begin{itemize}
    \item \cppcode{processing}, obiekt klasy \qtclass{QMutex}, muteks do zablokowania podczas generowania obrazu, aby parametry obrazu nie mogły być zmieniane podczas jego generowania.
