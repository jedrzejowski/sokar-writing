...
\par
W C++ jednym z największych problemów jest wyciek pamięci, pojawia się wtedy gdy zaalokujemy na stercie obiekt za pomocą operatora \cppcode{new} i nie usuniemy go gdy ten będzie potrzebny.
\par
